...
Adicionalmente, los objetivos propuestos en el Plan de Trabajo 2025 fueron alcanzados en gran medida. La producción científica del grupo se sostuvo, alcanzando un número significativo de publicaciones en revistas con referato. La presentación de trabajos en reuniones científicas nacionales e internacionales fue {\color{red} sensiblemente inferior a la correspondiente del año 2023, principalmente debido a los altos costos y las restricciones presupuestarias vigentes}. Todos los miembros del grupo han participado en la elaboración de trabajos que fueron publicados o comunicados a congresos y se mantuvieron los vínculos existentes con investigadores nacionales e internacionales a través de diversas colaboraciones.
...
Finalmente, durante el año 2025 finalizaron exitosamente dos PID homologados por la Universidad, se iniciaron dos PID, y se continuaron desarrollando las tareas de tres PICT (financiados por la ANPCyT) y dos PID. {\color{red} revisar esto}
...
{\small
	\begin{tabular}{l l l c c c}
		...
		Pilili, Esteban          & Jefe de Trabajos Prácticos & Simple     & B          &            & 15        \\
		\bottomrule
	\end{tabular}
}
...
\begin{itemize}
	...
	\item \textbf{PICT ANPCyT:} PICT-2020-SERIEA-I-GRF-02611, 2022-2024, Análisis de propiedades tensionales en carga y descarga de silos. Director: Marcos Madrid, codirector: Ariel Meyra.
	      ...
	      \textbf{Logros:} En el período 2024 se realizó la puesta en marcha y acondicionamiento un segundo equipo y se comenzó con los ensayos experimentales.
	...
	\item \textbf{PICT ANPCyT:} PICT-2021-I-A-00294, 2023 -- 2026, Experiments and modeling of particle dampers with obstacles. Director: Luis Pugnaloni. Integrante del grupo responsable: Manuel Carlevaro.
	      ...
	      \textbf{Logros: } Se completó el diseño y desarrollo de un programa de modelización y simulación computacional de un amortiguador granular en dos dimensiones, cuya geometría es optimizada por medio de un algoritmo genético, con el propósito de obtener la geometría óptima del contenedor de partículas. Se avanzó en la construcción de un dispositivo experimental para realizar la validación del modelo computacional.

	      \textbf{Dificultades:} Durante el año 2025 las actividades de la ANPCyT estuvieron paralizadas, sin que se obtenga el financiamiento pautado para este proyecto.
	...
	\item {\bf PID UTN:} MAECLP0009851TC, 2023-2026, {\bf Resolución de problemas Biomédicos y Biomiméticos por Elementos Finitos}. Director: Ramiro M. Irastorza.
	      ...
	      {\bf Logros:} se desarrolló un el modelo de torso simplificado inspirado en geometrías de cerdos de diferentes tamaños (provenientes de experimentos actuales llevados a cabo por colaboradores del exterior) donde se demostró el tamaño corporal tiene una influencia moderada en el efecto de la posición del parche dispersivo sobre el tamaño de la lesión por radiofrecuencia. La ventaja potencial de una configuración concordante del parche dispersivo puede ser más significativa en individuos con menor volumen corporal. También se trabajó de manera experimental, evaluando el efecto de la ablación por radiofrecuencia en tejido previamente desecado, se encontró que puede generar coagulación hasta 3 mm por debajo de éste, según ensayos en hígado ex vivo. También se encontró que una potencia media resulta más eficaz, mientras que niveles altos producen humo y coagulación superficial. El monitoreo de la corriente de RF, especialmente su continuidad y valor pico, puede guiar la selección óptima de potencia en cirugía. Finalmente, se continuó trabajando en termocoagulación de zonas epileptógenas (con modelos realistas construidos a partir de imágenes de cerebro), en particular, en heterotopía periventricular. Se desarrollaron simulaciones que permitieron probar que más allá de las consecuencias clínicas del daño en la superficie externa del ventrículo, no se muestra una alteración de la zona de coagulación debido a la proximidad del ventrículo. Se publicaron dos trabajos en revistas internacionales en esta temática y dos trabajos completos en el congreso de la Sociedad Argentina de Bioingeniería (SABI 2025). En la temática de biomecánica, se desarrolló un modelo simplificado por elementos finitos que permite simular condiciones fisiológicas y patológicas del disco intervertebral (cambios en la altura del disco, el volumen del núcleo pulposo y la cantidad de cemento óseo inyectado). El resultado se publicó como trabajo completo en las actas de la Asociación Argentina de Mecánica Computacional.
