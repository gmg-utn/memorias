...
\begin{itemize}
	...
	\item Se alcanzó una participación importante en congresos y reuniones científicas nacionales (siete) e internacionales (cinco).
	\item Se desarrollaron en nuestra facultad dos cursos de posgrado con una alta participación de estudiantes. 
	\item Se organizaron dos jornadas científico-técnicas.
  \item Se desarrolló una prueba piloto de funcionamiento de un consorcio con empresas agroindustriales.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Consejo Directivo:}
	      \begin{itemize}
		      ...
		      \item Willers Ruiz Altamirano - Representante del Departamento de Ingeniería Mecánica.
...
{\small
	\begin{tabular}{l l l c c c}
		...
		Fernández, Matías        & Prof. Titular              & Exclusiva  & D          &            & 20        \\
		Irastorza, Ramiro Miguel & Prof. Titular              & Simple     & B          & III        & 15        \\
		                         & Invest. Indep. CONICET     &            &            &            &           \\
		Madrid, Marcos Andrés    & Prof. Asociado              & Simple     & C          & III        & 15        \\
		                         & Invest. Adjunto. CONICET     &            &            &            &           \\
		Meyra, Ariel Germán      & Prof. Titular              & Simple     & C          & III        & 15        \\
		                         & Invest. Indep. CONICET     &            &            &            &           \\
		Sánchez, Martín          & Prof. Titular              & Simple     & B          &            & 15        \\
		Pilili, Esteban          & Jefe de Trabajos Prácticos & Exclusiva     &            &            & 20        \\
		\bottomrule
	\end{tabular}
}
...
\begin{itemize}
	...
	\item Diez computadoras de escritorio y para control de dispositivos de laboratorio.
	...
	\item Dos microscopios metalográficos de mesada.
...
Específicamente, el GMG incorporó durante 2025 un generador de funciones y fuente, y dos computadoras de escritorio.
...
No se incorporó nuevo material bibliográfico durante 2025.
...
\begin{itemize}
	...
	\item {\bf PID UTN:} MAUTNLP0009875, 2023-2026, {\bf Propiedades estructurales en carga y descarga de silos}. Director: Marcos Madrid, codirector: Manuel Carlevaro.
		      ...
		      {\bf Logros:} En el año 2025 se trabajó en la construcción de un prototipo de laboratorio para estudiar un sistema de elevación de granos a escala, y sobre la incidencia de las ondulaciones en las paredes de un silo. Se sumaron una becaria y un becario de investigación para contribuir en los diferentes proyectos y se sumaron dos estudiantes más para comenzar a trabajar en estos temas. Se presentaron cuatro trabajos a congresos y se publicaron dos trabajos con referato en revistas internacionales.

		      {\bf Dificultades:} No se presentaron dificultades durante la ejecución de la presente etapa.
	...
	\item \textbf{PID UTN:} ENECLP0010122, 2024--2027, \textbf{Incidencia de la viscosidad del fluido en el transporte del agente de sostén dentro de una fractura de yacimiento no convencional}. Director: Matías Fernández. 
	      ...
	      \textbf{Logros:} Se construyó un dispositivo para medición de viscosidades de fluidos. Se eligió un viscosímetro tipo Stokes controlado por Arduino para automatizar el proceso de medición. Esta herramienta sera de vital importancia para la caracterización de los distintos fluidos de fractura.

A finales del año pasado se gano por orden de merito en una convocatoria de la Universidad Tecnológica para la compra por un total de \$ 600.000 de materiales para doctorandos. A traves de una presentación por este PID y el becario Gracia se pudo realizar la compra de los materiales para preparar diferentes tipos de fluidos Croslinkers y gel lineal utilizados como fluido de fractura.  
Por otro lado, se realizaron ensayos utilizando la celda de transporte con tres tipos de agente de sostén para evaluar el impacto de la elección del material en el transporte y deposición de los mismo. En los estudios se vio que densidades mayores, existe una mejor deposición del material, evitando una posible desconexión entre la fractura y el casing. Al utilizar materiales distintos, pero de similares densidades, no hay diferencias significativas en cuanto a la deposición de los mismos.  

	      \textbf{Dificultades:} No hubo dificultades durante el año.
...
\begin{enumerate}
	...
	\item \fullcite{2025-06}.
	\item \fullcite{2025-07}.
	\item \fullcite{2025-08}.
\end{enumerate}

\subsubsection{En libros y capítulos de libros}

\begin{enumerate}
	\item F. Batista y Manuel Carlevaro. \textbf{Python para Ciencia y Tecnología}, 2025. Autoeditado, ISBN:  978-631-00-9794-7. \url{https://libropython.science/}.
\end{enumerate}

\subsubsection{Informes y memorias técnicas}
\begin{enumerate}
	\item Memoria anual del GMG para el período 2024 (ISSN: 2618-1738).
  \item Informe técnico «\textit{Ensayos computacionales de transporte granular en sinfín}». Prueba piloto del consorcio Agro.AR.
\end{enumerate}
\vspace{0.25cm}
...
\begin{itemize}
  ...
  \item \textbf{Referato de artículos para revistas internacionales}: durante 2025, C. Manuel Carlevaro fue revisor de artículos para la revista \textit{Journal of Statistical Mechanics - Theory and Experiment} (IOP) y \textit{Scientific Reports} (Nature Research). Marcos Madrid fue revisor de artículos para las revistas \textit{Granular Matter}, \textit{Processes} y \textit{BioResources}.

  \item \textbf{Actividades de gestión editorial:} C. Manuel Carlevaro fue Editor Asociado de \textit{Frontiers in Soft Matter}. Marcos Madrid se desempeñó como Editor Revisor de \textit{Frontiers}.
	...
	\item \textbf{Asociación Física Argentina:} C. Manuel Carlevaro se desempeñó como Revisor de Cuentas Suplente. Marcos Madrid fue parte del comité ejecutivo de la división Materia Blanda. Marcos Madrid fue miembro del Comité Organizador de la 110° RAFA y secretario de la Filial La Plata.
...
Los integrantes del CIMEC participamos de las siguientes actividades de divulgación:
...
\begin{itemize}
  ...
  \item III Festival en defensa de la ciencia soberana y la educación pública. Realizado el día 12 de abril de 2025 en la plaza Islas Malvinas de la ciudad de La Plata.
  \item La noche de los museos. Llevada a cabo en 16 de Noviembre de 2025 en los jardines del departamento de Física.
  \item Taller de divulgación en el marco de la XIII Jornadas de Divulgación Científica para Escuelas Primarias del CONICET La Plata: Construyendo CON-CIENCIA.
\end{itemize}
...
\begin{itemize}
	...
	\item {\bf Automatización Industrial:} R. Irastorza.
...
Los docentes del CIMEC se desempeñaron como docentes en los siguientes cursos de postgrado.

\begin{itemize}
	% \item {\bf Herramientas computacionales para científicos:} R. Irastorza. A. Meyra y C. M. Carlevaro.
  \item \textbf{Introducción a la Física de los Materiales Granulares:} M. Carlevaro y Marcos Madrid.
	\item \textbf{Método de elementos finitos con software libre:} R. Irastorza y A. Meyra.
\end{itemize}

% \section{Otras actividades} 
%
% El banco de pruebas de descarga de silos montado en los laboratorios del CIMEC se utiliza para que estudiantes de las cátedras de grado realicen trabajos prácticos experimentales sobre flujo de materiales granulares y distribución de tensiones en un silo.
...
\begin{center}
	\begin{tabular}{ l c c c }
		...
		\midrule
		UTN$^a$           & 1.800.000,00           & 1.116.000,00                               & 337.733,95          \\
		MAUTNLP0009875    & 1.080.000,00           & 324.000,00                                 & 440.000,00          \\
		MAUTCLP10087C     & 1.260.000,00           & 378.000,00                                 & 268.724,76          \\
		MAECLP0009851TC   & 1.080.000,00           & 324.085,00                                 & 658.414,95           \\
		ENECLP0010122     & 1.080.000,00           & 0,00                                 & 306.606,14                \\
		\midrule
		\textbf{Total:}   & 6.300.000,00           & 2.142.000,00                               & 2.011.479,80          \\
		\bottomrule
	\end{tabular}
\end{center}
...
\begin{itemize}
	...
	\item PID ENECLP0010122: Se caracterizarán dos tipos de fluidos Crosslinkers y un gel lineal. Se realizaran ensayos variando la velocidad de media de la fractura y se estudiará su impacto dinámico y estático en el transporte de agente de sostén. 
  \item PID UTN MAECLP0009875: Se concretará la finalización del proyecto continuando con las mediciones experimentales de presión en la base de los silos prototipo construidos, y se avanzará en la construcción de nuevos modelos complementarios para realizar experimentos con diferentes tolvas.
  \item PID UTN MAECLP0009851TC: Dado que el proyecto está finalizando se continuarán los trabajos asociados a la termocoagulación de zonas epileptógenas y se explorarán métodos de electroporación en diferentes tipos de cancer. Adicionalmente, continuaremos con la simulación de la biomecánica de columna con discoplastía y otras técnicas asociadas a la estabilidad de la misma.
\end{itemize}

En términos generales, son objetivos para el 2026:
\begin{itemize}
  \item Elaborar nuevos proyectos para proponer en la convocatoria anual de los PID UTN.
